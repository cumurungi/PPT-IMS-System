...
const filtered = computed(() => { if (!search.value)
    return preachers.value; const q = search.value.toLowerCase(); return preachers.value.filter(p => p.name.toLowerCase().includes(q) || p.specialization.toLowerCase().includes(q)); });
...
async function doDelete() { if (!deleteTarget.value)
    return; deleting.value = true; try {
    await api.delete(`/evangelism/preachers/${deleteTarget.value.id}`);
...
async function fetchPreachers() { loading.value = true; try {
    const { data } = await api.get('/evangelism/preachers');
    preachers.value = data;
}
catch (err) {
    console.error(err);
}
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "mb-4 flex-shrink-0 flex items-center gap-3" },
});
...
if (__VLS_ctx.loading) {
    ...
    for (const [p] of __VLS_getVForSourceType((__VLS_ctx.paginatedItems))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            key: (p.id),
        ...
        (p.name);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...{ class: "text-xs text-indigo-600 dark:text-indigo-400 mt-0.5" },
        });
        (p.specialization);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "ml-3 flex-shrink-0 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg px-2 py-1 text-center" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
        ...
        if (p.notes) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
                ...{ class: "mt-2 text-gray-600 dark:text-gray-300 italic line-clamp-2" },
            });
            (p.notes);
        }
        if (__VLS_ctx.auth.isManager) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                ...{ class: "mt-3 pt-3 border-t border-gray-100 dark:border-gray-700 flex gap-2" },
            });
            __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                ...{ onClick: (...[$event]) => {
                        if (!!(__VLS_ctx.loading))
                ...
                ...{ class: "flex-1 text-xs text-center py-1.5 rounded-lg border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300" },
            });
            __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                ...{ onClick: (...[$event]) => {
                        if (!!(__VLS_ctx.loading))
                ...
                ...{ class: "flex-1 text-xs text-center py-1.5 rounded-lg border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400" },
            });
        }
    }
...
if (__VLS_ctx.showCreate || __VLS_ctx.editTarget) {
    /** @type {[typeof PreacherModal, ]} */ ;
    // @ts-ignore
    const __VLS_10 = __VLS_asFunctionalComponent(PreacherModal, new PreacherModal({
        ...{ 'onClose': {} },
        ...{ 'onSaved': {} },
        preacher: (__VLS_ctx.editTarget),
    }));
...
if (__VLS_ctx.deleteTarget) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6" },
    });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...
        ...{ class: "flex-1 px-4 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.doDelete) },
        disabled: (__VLS_ctx.deleting),
        ...{ class: "flex-1 px-4 py-2 text-sm bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white rounded-lg" },
    });
