...
const LEAVE_STATUS = { PENDING: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300', APPROVED: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300', REJECTED: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' };
function leaveStatusClass(s) { return LEAVE_STATUS[s] ?? ''; }
function formatDate(d) { return new Date(d).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' }); }
async function createLeave() { formError.value = ''; submitting.value = true; try {
    await api.post('/hr/leave', form.value);
    showCreate.value = false;
    form.value = { leaveType: 'VACATION', startDate: '', endDate: '', reason: '' };
    await fetchLeaves();
}
catch (e) {
...
async function reviewLeave(id, status) { acting.value = true; try {
    await api.patch(`/hr/leave/${id}`, { status, reviewerComment: reviewComment.value || null });
...
async function fetchLeaves() { loading.value = true; try {
...
(__VLS_ctx.isHR ? 'Review and approve leave requests.' : 'Request and track your leave.');
...
if (__VLS_ctx.loading) {
    ...
    for (const [l] of __VLS_getVForSourceType((__VLS_ctx.paginatedItems))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            key: (l.id),
        ...
        (__VLS_ctx.formatDate(l.startDate));
        (__VLS_ctx.formatDate(l.endDate));
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
            ...{ class: (['text-xs px-2.5 py-1 rounded-full font-medium flex-shrink-0', __VLS_ctx.leaveStatusClass(l.status)]) },
        });
        (l.status);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...
            if (__VLS_ctx.reviewingId === l.id) {
                ...
                __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                    ...{ onClick: (...[$event]) => {
                            ...
                            if (!(__VLS_ctx.reviewingId === l.id))
                                return;
                            __VLS_ctx.reviewLeave(l.id, 'APPROVED');
                        } },
                ...
                __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                    ...{ onClick: (...[$event]) => {
                            ...
                            if (!(__VLS_ctx.reviewingId === l.id))
                                return;
                            __VLS_ctx.reviewLeave(l.id, 'REJECTED');
                        } },
                    disabled: (__VLS_ctx.acting),
...
if (__VLS_ctx.showCreate) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
        ...{ onSubmit: (__VLS_ctx.createLeave) },
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        value: (__VLS_ctx.form.leaveType),
        required: true,
    ...
    (__VLS_ctx.submitting ? 'Submitting...' : 'Submit Request');
}
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            setPage: setPage,
            leaveStatusClass: leaveStatusClass,
