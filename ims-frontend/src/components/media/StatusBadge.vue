<template>
  <span :class="['inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap', colorClass]">
    {{ label }}
  </span>
</template>
...
const map: Record<string, { class: string; label: string }> = {
  // Editing status
  PENDING: { class: 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300', label: 'Pending' },
  ...
  ON_HOLD: { class: 'bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-300', label: 'On Hold' },
